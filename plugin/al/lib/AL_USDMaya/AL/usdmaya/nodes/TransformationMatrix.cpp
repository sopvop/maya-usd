            ...
            case kRotate: {
                ...
                if (readFromPrim) {
                    ...
                    if (transformNode) {
                        ...
                        // appeear to be via MFnTransform :( MFnTransform
                        // fn(m_transformNode.object()); fn.setRotation(m_rotationFromUsd);
                        // MFnTransform hack breaks parallel computation
                        MPlug(transformNode->thisMObject(), MPxTransform::rotateX)
                            .setValue(m_rotationFromUsd.x);
                        MPlug(transformNode->thisMObject(), MPxTransform::rotateY)
                            .setValue(m_rotationFromUsd.y);
                        MPlug(transformNode->thisMObject(), MPxTransform::rotateZ)
                            .setValue(m_rotationFromUsd.z);
                    }
                }
            } break;
